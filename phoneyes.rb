...
then
  ...
  then
    puts "" "Thanks for flying with American airlines.
...
\n Do you get in his truck? yes or no ?" ""
  ...
  then
    puts "" "Thank you For flying with Delta today, you had your choice of airlines and well you chose the wrong one.......Our flight
time should be around 7 hours barring any unforeseen circumstances such as pilot error or just plane not caring....(get it..... Plane?)
...
When you ask why? They say because We said so and up here we are the boss...... Do you sit back down?" ""
      ...
      if dechoice2.include?("Y") or dechoice2.include?("S")
        puts "man they suck"
      elsif dechoice2.include? ("N") then
      ...
      then
        puts "what who dont use the bathroom?"
      end
    end
  end
