...
puts"""#{user_name} and Ismael start for the African wildnerness and around 2 hours in to #{user_name} & Ismael's trip when Ismael spots what appears to be 
poachers down the range...."""
sleep 1
poanimal
bangbang
